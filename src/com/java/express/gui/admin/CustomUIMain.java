...
public class CustomUIMain extends JFrame {
	...
	private JPanel backgroundPanel, topBluePanel, topGrayPanel, homePanel, userPanel, bookPanel;
	...
	public CustomUIMain(JPanel backgroundPanel, JPanel homePanel, JPanel userPanel, JPanel bookPanel) {
		this.backgroundPanel = backgroundPanel;
	...
	public void setMainPanel() {
		...
		userPanel.setBounds(25, 150, 1650, 860);
	...
	public void setModalPanel() {
		...
		this.topBluePanel = new JPanel();
		topBluePanel.setBounds(0, 0, 1000, 70);
		topBluePanel.setBackground(new Color(26, 27, 32));
		topBluePanel.setLayout(null);
		backgroundPanel.add(topBluePanel); 
		
		this.topGrayPanel = new JPanel();
		topGrayPanel.setBounds(0, 70, 1000, 50);
		topGrayPanel.setBackground(new Color(230, 236, 240));
		topGrayPanel.setLayout(null);
		backgroundPanel.add(topGrayPanel);
